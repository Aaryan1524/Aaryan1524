...
<img src="assets/card.svg" width="100%" alt="A chat card cycling through three answers. if you are hiring: &quot;Can you ship a feature end to end?&quot; — Yes. Here is the stack. (Python, FastAPI, React, PostgreSQL, C# / .NET, Docker) if you are investing: &quot;What are you building?&quot; — Te Vārtā: news that finds you. (Te Vārtā, Knowledge graph, iOS app, tevarta.com) if you build things: &quot;What is under the hood?&quot; — Deterministic core, LLM at the edge. (Neo4j, RAG pipelines, spaCy, Claude API, Docker)">
